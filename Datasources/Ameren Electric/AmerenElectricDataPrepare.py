...
engine.energyProviderName = "Ameren Electric"
...
engine.inputFileDateColumnName = "Start Interval Date/Time"
...
engine.inputFileNumHeaderRows = 10
...
engine.outputFiles = [
    OutputFileDefinition(
        ...
        "Usage",
        [DataFilter("Interval", "^60min$", True)],
        True,
    ),
]
