...
engine.energyProviderName = "Zonneplan"
...
engine.inputFileDateColumnName = "DateTo"
...
engine.inputFileNumFooterRows = 2
...
engine.outputFiles = [
    OutputFileDefinition(
        ...
        "ElectricityConsumptionUsageKwh",
        [],
        IntervalMode.USAGE,
    ),
    OutputFileDefinition(
        "elec_feed_out_tariff_1_high_resolution.csv",
        "ElectricityProductionUsageKwh",
        [],
        IntervalMode.USAGE,
    ),
    OutputFileDefinition(
