...
NextEnergy doesn't offer the option to export data from the website or mobile app but it is possible to request data via customer service. This data can be transformed and used to import into Home Assistant.
