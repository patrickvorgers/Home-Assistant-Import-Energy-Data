...
def generateImportDataFiles(path, greenChoiceCSVFileName):

    inputCSVFile = path + os.sep + greenChoiceCSVFileName
    if os.path.exists(inputCSVFile):
        print('Found file: ' + inputCSVFile)
        
        print('Opening input CSV data')
        # Open the specified file 
        dataFrame = pd.read_csv(inputCSVFile, sep = ';', decimal = '.', parse_dates = ['OpnameDatum'])
        ...
        print('Could not find file: ' + inputCSVFile)
