...
inputFileDateTimeColumnFormat = "%Y-%m-%dT%H:%M:%S%z"
...
outputFiles = [OutputFileDefinition('elec_feed_in_tariff_1_high_resolution.csv', 'Verbruik', [DataFilter('Type', 'Elektriciteit', True), DataFilter('Piek', 'true', True)], True),
               OutputFileDefinition('elec_feed_in_tariff_2_high_resolution.csv', 'Verbruik', [DataFilter('Type', 'Elektriciteit', True), DataFilter('Piek', 'false', True)], True),
               OutputFileDefinition('gas_high_resolution.csv', 'Verbruik', [DataFilter('Type', 'Gas', True)], True)
              ]
