...
Eneco offers the option to export data from the [Mijn Oxxio](https://inloggen.oxxio.nl/) website. This data can be transformed and used to import into Home Assistant.
...
- Download the ```OxxioDataPrepare.py``` file and put it in the same directory as the Eneco data
