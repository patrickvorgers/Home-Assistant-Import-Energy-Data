...
dataPreparation = "df['Energy Delivered (Wh)'] = df['Energy Delivered (Wh)'].str.replace(',', '').replace('\"', '').astype(int)"

# List of one or more output file definitions
outputFiles = [OutputFileDefinition('elec_solar_high_resolution.csv', 'Energy Delivered (Wh)', [], True)]
